...
function VierpInput({ label, required, locked, rightElement, className, ...props }: VierpInputProps) {
  return (
    ...
    >
      {label && (
        <legend className="px-1 text-[10px] font-medium text-slate-500 bg-white leading-none select-none ml-2">
...
export default function VierpProfilePage({ profile, onNavigate }: VierpProfilePageProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    facebookLink: 'https://facebook.com/aditya.sharma.official',
    facultyWebLink: isFaculty ? 'https://college.edu/faculty/rajesh-kulkarni' : 'https://college.edu/students/22110482',
    linkedinLink: 'https://linkedin.com/in/aditya-sharma-ce',
    instagramLink: 'https://instagram.com/aditya_sharma_tech',
    scholarLink: 'https://scholar.google.com/citations?user=aditya22110482',
    vidwanLink: 'https://vidwan.inflibnet.ac.in/profile/22110482',
  })
  ...
  return (
    <div className="w-full pb-28">
        ...
        <main className="flex-1 w-full bg-white rounded-2xl border border-[#E2E8F0] shadow-sm overflow-hidden flex flex-col min-h-[640px]">
          ...
          {activeRail === 'personal' && (
            <div className="flex-1 flex flex-col">
              ...
              <div className="rounded-t-2xl border border-b-0 border-[#BFDBFE] bg-gradient-to-r from-[#BFDBFE] via-[#DBEAFE] to-[#EFF6FF] p-1.5 flex items-center gap-1 overflow-x-auto">
                {[
                  ...
                  <button
                    ...
                    className={cn(
                      personalSubTab === tab.id
                        ? 'bg-white text-[#0F172A] font-extrabold text-[11px] tracking-wide px-4 py-2.5 rounded-t-xl whitespace-nowrap shadow-none border-b-0 -mb-[1px]'
                        : 'text-[#1E3A8A] text-[11px] font-bold tracking-wide uppercase px-4 py-2.5 whitespace-nowrap hover:text-[#002B9A]'
                    )}
                  >
                    {tab.label}
                  </button>
              ...
              <div className="p-6 flex-1">
                {bankSubTab === 'bank_info' && (
                  <div className="space-y-4 max-w-2xl">
                    <div className="rounded-lg border border-[#FCD34D] bg-[#FFFBEB] p-3 text-xs text-[#92400E] flex items-center gap-2.5">
                      <Lock className="w-4 h-4 flex-shrink-0 text-amber-700" />
                      <span>
                        Bank details are securely locked by the College Accounts Department. To request modification, submit verified bank passbook copy (showing account number, IFSC code, and account holder name) at Academic Section Window 4.
                      </span>
                    </div>
          ...
          {/* ================= RAIL 9: SOCIAL INFORMATION ================= */}
          {activeRail === 'social' && (
            <div className="p-6 flex-1 flex flex-col justify-between">
              <div className="space-y-6 max-w-4xl">
                <div className="border-b border-[#E2E8F0] pb-3 flex items-center justify-between">
                  <div>
                    <h3 className="text-sm font-bold text-[#0F172A]">Add Social Information</h3>
                    <p className="text-xs text-[#64748B] mt-0.5">
                      Configure institutional public research and networking profiles
                    </p>
                  </div>
                  <div className="text-[11px] font-medium text-blue-600 bg-blue-50 px-2.5 py-1 rounded-full border border-blue-100 flex items-center gap-1.5">
                    <Sparkles className="w-3.5 h-3.5" />
                    <span>Public Institutional Portfolio</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  />
                  <VierpInput
                    label="Faculty Web Page Link"
                    placeholder="https://college.edu/faculty/profile"
                    value={formData.facultyWebLink}
                    onChange={(e) => handleChange('facultyWebLink', e.target.value)}
                  />
                  <VierpInput
                    label="Linkedin Link"
                  ...
                  <VierpInput
                    ...
                    onChange={(e) => handleChange('vidwanLink', e.target.value)}
                  />
                </div>
              </div>

              {/* Blue SAVE Action Button */}
              <div className="pt-6 mt-6 border-t border-[#E2E8F0] flex justify-end">
                <button
                  type="button"
                  onClick={() => handleSave('Social Information')}
                  disabled={isSaving}
                  className="bg-[#2563EB] hover:bg-[#1D4ED8] text-white text-xs font-bold px-6 py-2.5 rounded-lg shadow-sm hover:shadow-md transition-all flex items-center gap-2 cursor-pointer active:scale-95 disabled:opacity-60"
                >
                  <Save className="w-4 h-4" />
          ...
          {activeRail === 'photos' && (
            <div className="p-6 flex-1 space-y-6 max-w-4xl">
              <div className="rounded-lg border border-[#FCD34D] bg-[#FFFBEB] p-3 text-xs text-[#92400E]">
                <div className="flex items-center gap-1.5 mb-2 font-bold text-xs text-[#92400E]">
                ...
                <ul className="text-xs space-y-1.5 pl-6 list-disc font-medium text-[#92400E]">
      ...
      <footer className="fixed bottom-0 left-0 right-0 z-30 bg-[#1E40AF] text-white py-2 px-4 flex items-center justify-between shadow-lg text-xs print:hidden">
